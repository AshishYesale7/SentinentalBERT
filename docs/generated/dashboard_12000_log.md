...
> **File Type**: unknown | **Path**: `dashboard_12000.log` | **Lines**: 28
...
```mermaid
graph TD
    A[Social Media APIs] --> B[dashboard_12000.log]
...
```unknown
  ...
  URL: http://0.0.0.0:12000

ERROR:__main__:Failed to import services: No module named 'torch'
WARNING:__main__:Some services not available: No module named 'torch'
ERROR:__main__:Error initializing services: name 'BehavioralPatternAnalyzer' is not defined
WARNING:__main__:Could not initialize sentiment model: a coroutine was expected, got {'status': 'mock', 'data': []}
INFO:services.database.tracking_cache:Database initialized successfull...
```
